...
// STEP 5
// let firstName = "Orlando";
// let lastName = "Boquin";
// let city = "San Diego";

//STEP 6
// Create a variable. Add a number and a string and display the coerced result in the browser’s console window.
//let studentName = 'Orlando'
//alert('This is ' + studentName  + ' variable exercise number ' + 1 + '. ' + ' Now, ' + studentName + ' has to ignore the worldcup and practice javascript everyday. ')
...
//let firstName = 'Orlando'
//let isAStudent = true
//console.log( firstName + ' is a ' + isAStudent + ' student')
